...
const Thought = ( { using } ) => {
    ...
    function postComment() {
        ...
        fetch('https://thoughtscloud.vercel.app/comment', { 
            method : 'POST',
    ...
    useEffect(() => {
        ...
        fetch('https://thoughtscloud.vercel.app/thought/' + thoughtId )
        .then((res) => res.json())
        .then((result) => {
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            let thoughtId = localStorage.getItem('thought')
            fetch('https://thoughtscloud.vercel.app/comments/' + thoughtId)
